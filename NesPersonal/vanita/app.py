...
def index():
    ...
    return render_template("index.html", hide_login=hide_login)
...
#         if not symbol:
#             return apology("Please enter a Symbo!")
#         elif not item:
...
#         if shares <= 0:
#             return apology ("Shares must be greater than 0 AND symbol = ? GROUP BY symbol", user_id, symbol)[0]["shares"]
...
#             return apology("Owned shares execed")
